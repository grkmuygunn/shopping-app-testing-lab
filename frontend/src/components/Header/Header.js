  ...
  return (
    <header data-testid={headerID} className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-lg">
      <div className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <Link to="/cart" className="flex items-center space-x-2 bg-white text-indigo-600 px-4 py-2 rounded-full transition duration-300 hover:bg-indigo-100" data-testid="cart-link">
